...
private void Awake()
    ...
    public void GoToNextSection()
    {
        ...
        {
            Debug.Log("Juego completado. Ir a cr�ditos.");
        ...
        if (nextConfig.requiresSceneLoad)
        {
            ...
            {
                Debug.LogError($"[GameFlowManager] La escena '{nextConfig.sceneName}' no est� en la lista de SceneLoader.");
            }

            return; // No cambia de estado todav�a
        }

        //Si no requiere carga, contin�a al siguiente estado directamente
