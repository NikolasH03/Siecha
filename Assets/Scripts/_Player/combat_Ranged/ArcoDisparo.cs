...
public class ArcoDisparo : MonoBehaviour
{
    ...
    private void VerificarLimitesDestruccion()
    {
        ...
        {
            Debug.Log($"Flecha destruida por distancia m�xima: {distanciaRecorrida}m");
            DestruirFlecha();
            return;
        }
        ...
        //{
        //    Debug.Log($"Flecha destruida por altura m�xima: {transform.position.y}m");
        //    DestruirFlecha();
        //    return;
        //}
        ...
        {
            Debug.Log("Flecha destruida por caer al vac�o");
            DestruirFlecha();
            return;
        }
    ...
    private void ManejarImpactoEnemigo(Collider enemyCollider)
    {
        ...
        if (player != null)
        {
            ...
            if (enemigo != null)
            {
                ...
                Debug.Log($"Flecha impact� enemigo: {enemyCollider.gameObject.name}");
            }
        }
    ...
    private void ManejarImpactoObstaculo(Collider obstaculoCollider)
    {
        ...
        Debug.Log($"Flecha impact� obst�culo: {obstaculoCollider.gameObject.name}");
