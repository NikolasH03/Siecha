	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord125 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord136 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float Overall_Speed165 = _OverallSpeed;
				float2 texCoord151 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 uv_MasksTexture = input.ase_texcoord2.xy * _MasksTexture_ST.xy + _MasksTexture_ST.zw;
...
ASEEND*/
//CHKSM=548872EB2430A41777591D1F18886FA8CC9DE9F5